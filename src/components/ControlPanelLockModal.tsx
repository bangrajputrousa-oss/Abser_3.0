      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-sm bg-[#211F1F] border border-neutral-700/80 rounded-3xl p-6 shadow-2xl flex flex-col gap-5 text-white"
          >
            ...
            <form onSubmit={handleUnlock} className="flex flex-col gap-3">
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-[11px] text-emerald-400 hover:text-emerald-300 active:scale-95 transition-transform cursor-pointer"
                  >
                    Paste
                  </button>
                </div>
                ...
                <div className="relative flex items-center">
                  ...
                  <button
                    ...
                    className="absolute right-3 text-neutral-400 hover:text-neutral-200 cursor-pointer p-1 active:scale-90 transition-transform"
              ...
              <div className="flex items-center gap-2.5 pt-2">
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-neutral-800 hover:bg-neutral-700 active:scale-[0.98] text-neutral-300 font-semibold text-xs rounded-xl cursor-pointer transition-all"
                >
                  Cancel
                </button>
